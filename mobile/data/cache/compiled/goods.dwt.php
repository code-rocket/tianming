...
?>
      ...
      <div class="ect-padding-lr ect-padding-tb goods-submit">
        <div style="width:49%; float:left;"><a type="botton" class="btn btn-info ect-btn-info ect-colorf" href="javascript:addToCart_quick(<?php echo $this->_var['goods']['goods_id']; ?>)"><?php echo $this->_var['lang']['buy_now']; ?></a></div>
        <div style="width:49%; float:left; margin-left:2%"><a type="botton" class="btn btn-info ect-btn-info ect-colorf theme-login" href="#">立即试戴</a></div>
      </div>
      
      
      
<link rel="stylesheet" href="/mobile/themes/default/css/lanrenzhijia.css" media="all">
<script src="/mobile/themes/default/js/jquery.minbox.js"></script>
<script>
jQuery(document).ready(function($) {
	$('.theme-login').click(function(){
		window.location.href="/../../shidai/index_mobile.php";
                ...
                <div class="box_center">
                  <div class="box_center_1">
                        <div class="box_center_a">
                          <a href="index2.html" onFocus="this.blur()"><img src="/mobile/themes/default/img/index_1.png"></a>
                          <p><a href="index2.html" onFocus="this.blur()">本地上传照片</a></p>
                      </div>
                        <div class="box_center_b">
                          <a href="index3.html" onFocus="this.blur()"><img src="/mobile/themes/default/img/index_2.png"></a>
                          <p><a href="index3.html" onFocus="this.blur()">自选模特</a></p>
                        </div>
                        <div class="box_center_c">
                          <a href="#" onFocus="this.blur()"><img src="/mobile/themes/default/img/index_3.png"></a>
                          <p><a href="#" onFocus="this.blur()">摄像头拍摄</a></p>
                        </div>
                    </div>
                </div>
...
?>
  ...
  <div class="goods-related ect-padding-lr ect-padding-tb">
    ...
    <div id="picScroll" class="picScroll">
      ...
      <div class="bd">
        <ul>
          <?php $_from = $this->_var['related_goods']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'goods_0_20410700_1464699271');$this->_foreach['goods'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['goods']['total'] > 0):
    foreach ($_from AS $this->_var['goods_0_20410700_1464699271']):
        $this->_foreach['goods']['iteration']++;
?>
          <li><a href="<?php echo $this->_var['goods_0_20410700_1464699271']['url']; ?>"><img _src="<?php echo $this->_var['goods_0_20410700_1464699271']['goods_thumb']; ?>" src="<?php echo $this->_var['goods_0_20410700_1464699271']['goods_thumb']; ?>" /></a>
            <p class="ect-color"> 
              <?php if ($this->_var['goods_0_20410700_1464699271']['promote_price']): ?> 
              <?php echo $this->_var['goods_0_20410700_1464699271']['formated_promote_price']; ?>
              <?php else: ?> 
              <?php echo $this->_var['goods_0_20410700_1464699271']['shop_price']; ?>
              <?php endif; ?> 
            </p>
            <p class="text-left"><?php echo $this->_var['goods_0_20410700_1464699271']['short_name']; ?></p>
          </li>
  ...
  <!--<footer class="logoRight <a href="http://www.zjxo.cn" title="杭州向欧" target="_blank">杭州向欧</a></footer>-->
</div>
