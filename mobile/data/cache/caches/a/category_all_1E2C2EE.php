<?php exit;?>a:3:{s:8:"template";a:4:{i:0;s:70:"C:\websoft\web\phpwind\tianming\mobile/themes/default/category_all.dwt";i:1;s:77:"C:\websoft\web\phpwind\tianming\mobile/themes/default/library/page_header.lbi";i:2;s:72:"C:\websoft\web\phpwind\tianming\mobile/themes/default/library/search.lbi";i:3;s:77:"C:\websoft\web\phpwind\tianming\mobile/themes/default/library/page_footer.lbi";}s:7:"expires";i:1468018619;s:8:"maketime";i:1468015019;}<!DOCTYPE html>
<html lang="zh-CN">
<head>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no">
<title>颜色_女款展厅_天明眼镜 - Powered by Xiang Ou 触屏版</title>
...
<div class="panel panel-default ect-category-all ect-border-radius0" >
    <ul>
          <li>
     	        <a href="/mobile/index.php?m=default&c=category&a=index&id=72"><div class="media panel-body"> 
           ...
           <li>
     	        <a href="/mobile/index.php?m=default&c=category&a=index&id=73"><div class="media panel-body"> 
            <div class="pull-left ect-category-right">
                <h3>咖啡色</h3>
                <h5 style="display:none;"> </h5>
            </div>
           ...
           <li>
     	        <a href="/mobile/index.php?m=default&c=category&a=index&id=74"><div class="media panel-body"> 
            <div class="pull-left ect-category-right">
                <h3>蓝色</h3>
                <h5 style="display:none;"> </h5>
            </div>
           ...
           <li>
     	        <a href="/mobile/index.php?m=default&c=category&a=index&id=75"><div class="media panel-body"> 
            <div class="pull-left ect-category-right">
                <h3>紫色</h3>
                <h5 style="display:none;"> </h5>
            </div>
           ...
           <li>
     	        <a href="/mobile/index.php?m=default&c=category&a=index&id=76"><div class="media panel-body"> 
            <div class="pull-left ect-category-right">
                <h3>红色</h3>
                <h5 style="display:none;"> </h5>
            </div>
           ...
           <li>
     	        <a href="/mobile/index.php?m=default&c=category&a=index&id=77"><div class="media panel-body"> 
            <div class="pull-left ect-category-right">
                <h3>玳瑁色</h3>
                <h5 style="display:none;"> </h5>
            </div>
           ...
           <li>
     	        <a href="/mobile/index.php?m=default&c=category&a=index&id=78"><div class="media panel-body"> 
            <div class="pull-left ect-category-right">
                <h3>黑白色系</h3>
                <h5 style="display:none;"> </h5>
            </div>
           ...
           <li>
     	        <a href="/mobile/index.php?m=default&c=category&a=index&id=79"><div class="media panel-body"> 
            <div class="pull-left ect-category-right">
                <h3>彩色系</h3>
                <h5 style="display:none;"> </h5>
            </div>
           ...
           <li>
     	        <a href="/mobile/index.php?m=default&c=category&a=index&id=80"><div class="media panel-body"> 
            <div class="pull-left ect-category-right">
                <h3>花纹系</h3>
                <h5 style="display:none;"> </h5>
            </div>
