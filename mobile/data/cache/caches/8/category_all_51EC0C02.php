<?php exit;?>a:3:{s:8:"template";a:4:{i:0;s:69:"/home/wwwroot/default/tianming/mobile/themes/default/category_all.dwt";i:1;s:76:"/home/wwwroot/default/tianming/mobile/themes/default/library/page_header.lbi";i:2;s:71:"/home/wwwroot/default/tianming/mobile/themes/default/library/search.lbi";i:3;s:76:"/home/wwwroot/default/tianming/mobile/themes/default/library/page_footer.lbi";}s:7:"expires";i:1476381247;s:8:"maketime";i:1476377647;}<!DOCTYPE html>
<html lang="zh-CN">
<head>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no">
<title>材质_男款展厅_天明眼镜 - Powered by Xiang Ou 触屏版</title>
...
<div class="panel panel-default ect-category-all ect-border-radius0" >
    <ul>
          <li>
     	        <a href="/mobile/index.php?m=default&c=category&a=index&id=8"><div class="media panel-body"> 
           ...
           <li>
     	        <a href="/mobile/index.php?m=default&c=category&a=index&id=23"><div class="media panel-body"> 
            <div class="pull-left ect-category-right">
                <h3>纯钛</h3>
                <h5 style="display:none;"> </h5>
            </div>
           ...
           <li>
     	        <a href="/mobile/index.php?m=default&c=category&a=index&id=24"><div class="media panel-body"> 
            <div class="pull-left ect-category-right">
                <h3>TR</h3>
                <h5 style="display:none;"> </h5>
            </div>
           ...
           <li>
     	        <a href="/mobile/index.php?m=default&c=category&a=index&id=35"><div class="media panel-body"> 
            <div class="pull-left ect-category-right">
                <h3>碳纤维</h3>
                <h5 style="display:none;"> </h5>
            </div>
           ...
           <li>
     	        <a href="/mobile/index.php?m=default&c=category&a=index&id=37"><div class="media panel-body"> 
            <div class="pull-left ect-category-right">
                <h3>塑钢</h3>
                <h5 style="display:none;"> </h5>
            </div>
           ...
           <li>
     	        <a href="/mobile/index.php?m=default&c=category&a=index&id=41"><div class="media panel-body"> 
            <div class="pull-left ect-category-right">
                <h3>金属合金</h3>
                <h5 style="display:none;"> </h5>
            </div>
           ...
           <li>
            ...
            <div class="pull-left ect-category-right">
                <h3>板材</h3>
                <h5 style="display:none;">                                     镜片 
                        </h5>
            </div>
            <i class="fa fa-angle-down ect-transition05"></i>
        </div>
                <div class="ect-category-child">
                <a href="/mobile/index.php?m=default&c=category&a=index&id=140">镜片</a>
         
        </div>
      </li>
           <li>
     	        <a href="/mobile/index.php?m=default&c=category&a=index&id=46"><div class="media panel-body"> 
            <div class="pull-left ect-category-right">
                <h3>聚合物</h3>
                <h5 style="display:none;"> </h5>
            </div>
