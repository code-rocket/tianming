<?php exit;?>a:3:{s:8:"template";a:4:{i:0;s:70:"C:\websoft\web\phpwind\tianming\mobile/themes/default/category_all.dwt";i:1;s:77:"C:\websoft\web\phpwind\tianming\mobile/themes/default/library/page_header.lbi";i:2;s:72:"C:\websoft\web\phpwind\tianming\mobile/themes/default/library/search.lbi";i:3;s:77:"C:\websoft\web\phpwind\tianming\mobile/themes/default/library/page_footer.lbi";}s:7:"expires";i:1468775767;s:8:"maketime";i:1468772167;}<!DOCTYPE html>
<html lang="zh-CN">
<head>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no">
<title>材质_女款展厅_天明眼镜 - Powered by Xiang Ou 触屏版</title>
...
<div class="panel panel-default ect-category-all ect-border-radius0" >
    <ul>
          <li>
     	        <a href="/mobile/index.php?m=default&c=category&a=index&id=58"><div class="media panel-body"> 
           ...
           <li>
     	        <a href="/mobile/index.php?m=default&c=category&a=index&id=59"><div class="media panel-body"> 
            <div class="pull-left ect-category-right">
                <h3>金属</h3>
                <h5 style="display:none;"> </h5>
            </div>
           ...
           <li>
     	        <a href="/mobile/index.php?m=default&c=category&a=index&id=60"><div class="media panel-body"> 
            <div class="pull-left ect-category-right">
                <h3>TR</h3>
                <h5 style="display:none;"> </h5>
            </div>
           ...
           <li>
     	        <a href="/mobile/index.php?m=default&c=category&a=index&id=61"><div class="media panel-body"> 
            <div class="pull-left ect-category-right">
                <h3>弹力钢</h3>
                <h5 style="display:none;"> </h5>
            </div>
           ...
           <li>
     	        <a href="/mobile/index.php?m=default&c=category&a=index&id=62"><div class="media panel-body"> 
            <div class="pull-left ect-category-right">
                <h3>塑钢</h3>
                <h5 style="display:none;"> </h5>
            </div>
           ...
           <li>
     	        <a href="/mobile/index.php?m=default&c=category&a=index&id=63"><div class="media panel-body"> 
            <div class="pull-left ect-category-right">
                <h3>碳纤维</h3>
                <h5 style="display:none;"> </h5>
            </div>
           ...
           <li>
     	        <a href="/mobile/index.php?m=default&c=category&a=index&id=64"><div class="media panel-body"> 
            <div class="pull-left ect-category-right">
                <h3>钛架</h3>
                <h5 style="display:none;"> </h5>
            </div>
           ...
           <li>
     	        <a href="/mobile/index.php?m=default&c=category&a=index&id=65"><div class="media panel-body"> 
            <div class="pull-left ect-category-right">
                <h3>聚合物</h3>
                <h5 style="display:none;"> </h5>
            </div>
