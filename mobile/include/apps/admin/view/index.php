...
<title>{$lang['cp_home']} - Powered by Xiang Ou</title>
...
<div id="admin_bottom" style="text-align:center; line-height:30px">Copyright &copy; <?php echo date('Y');?> 杭州向欧电子商务有限公司. All Rights Reserved.</div>
