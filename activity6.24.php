...
$smarty->assign('diys_kuang',             t_diys_kuang());//镜框

$smarty->assign('jk',                     jk());//镜框加载

$smarty->assign('diys_kuang1',             t_diys_kuang1());//镜腿

$smarty->assign('jk1',                     jk1());//镜腿加载

$smarty->assign('diys_kuang2',             t_diys_kuang2());//镜片

$smarty->assign('jk2',                     jk2());//镜片加载

$smarty->assign('jk_jt_jp',                     jk_jt_jp());//DIY价格


$smarty->assign('jk_jt_jp_title',                     jk_jt_jp_title());//DIY标题


$smarty->assign('jk_jt_jp_price',                     jk_jt_jp_price());//DIY链接



$smarty->assign('fittings',            get_goods_fittings(array(1)));                   // 配件
...
function jk_jt_jp_price()
{
	...
	$url="[{goodsId:".$jk_id."},{goodsId:".$jt_id."},{goodsId:".$jp_id."}]";
...
function jk_jt_jp_title()
{
	...
	$alltitle=$info['goods_name'].$info1['goods_name'].$info2['goods_name'];
