...
<div id="facediv" style="position: relative; ">
    ...
    <?php 
	  ...
	  {
	?>
    <input onClick="aaa(<?php echo $val['jingpian_width']?>,<?php echo $val['jingjia_width']?>,<?php echo $val['bituo_width']?>,<?php echo $val['jingpian_height']?>)" type="button" value="<?php echo $val['jingpian_width']?>">
