...
<body>
<div class="post_box" style="width:370px; overflow:hidden;">
	<div class="post_box_left">
    	<div class="post_box_pic" id="picDiv" style="margin:0 auto; background:url(<?=$url?>); background-size:100% auto; background-repeat:no-repeat; background-position:center;">
      ...
      <div class="post_box_pic_1">
        	<div class="post_box_pic_2">
            	<a href="index2_mobile.php" onFocus="this.blur()"><input type="image" src="img/anniu_3.png"></a>
          </div>
        </div>
    </div>
