      ...
      <div id="pos_wrap">
        <div class="tg_dtl_Right Right">
          <div class="tg_dtlR">
            ...
            <ul class="list">
              <?php $_from = $this->_var['gb_list_hot']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'group_buy_0_82983700_1477411519');$this->_foreach['hotcun'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['hotcun']['total'] > 0):
    foreach ($_from AS $this->_var['group_buy_0_82983700_1477411519']):
        $this->_foreach['hotcun']['iteration']++;
?>
              <li>
                <p> <a href="<?php echo $this->_var['group_buy_0_82983700_1477411519']['url']; ?>" title="<?php if ($this->_var['group_buy_0_82983700_1477411519']['group_title']): ?><?php echo $this->_var['group_buy_0_82983700_1477411519']['group_title']; ?><?php else: ?><?php echo $this->_var['group_buy_0_82983700_1477411519']['act_name']; ?><?php endif; ?>" target="_blank"><img src="themes/meilele/images/blank.gif" data-src="<?php echo $this->_var['group_buy_0_82983700_1477411519']['group_img']; ?>" width="180" height="118" alt="<?php if ($this->_var['group_buy_0_82983700_1477411519']['group_title']): ?><?php echo $this->_var['group_buy_0_82983700_1477411519']['group_title']; ?><?php else: ?><?php echo $this->_var['group_buy_0_82983700_1477411519']['act_name']; ?><?php endif; ?>"/></a> </p>
                <p class="name"> <a href="<?php echo $this->_var['group_buy_0_82983700_1477411519']['url']; ?>" title="<?php if ($this->_var['group_buy_0_82983700_1477411519']['group_title']): ?><?php echo $this->_var['group_buy_0_82983700_1477411519']['group_title']; ?><?php else: ?><?php echo $this->_var['group_buy_0_82983700_1477411519']['act_name']; ?><?php endif; ?>" target="_blank"><?php if ($this->_var['group_buy_0_82983700_1477411519']['group_title']): ?><?php echo $this->_var['group_buy_0_82983700_1477411519']['group_title']; ?><?php else: ?><?php echo $this->_var['group_buy_0_82983700_1477411519']['act_name']; ?><?php endif; ?></a> </p>
                <p class="tprc"> 团购价:<span class="yen">¥
                  <?php $_from = $this->_var['group_buy_0_82983700_1477411519']['price_ladder']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'item');$this->_foreach['foo'] = array('total' => count($_from), 'iteration' => 0);
...
?>
                ...
                <p class="prc clearfix"> <span class="Left">原价:<del class="yen"><?php echo $this->_var['group_buy_0_82983700_1477411519']['market_price']; ?></del></span><span class="Right">已团购<b><?php if ($this->_var['group_buy_0_82983700_1477411519']['isg_rs'] == 1): ?><?php echo $this->_var['group_buy_0_82983700_1477411519']['group_rs']; ?><?php else: ?><?php echo $this->_var['group_buy_0_82983700_1477411519']['cur_amount']; ?><?php endif; ?></b>件</span> </p>
              </li>
              <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
            </ul>
          </div>
