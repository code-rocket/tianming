...
?>
  ...
  <table class="w mt20 cart_table" id="JS_list_table_cb">
    <tr>
      ...
      <?php if (( $this->_var['diy_flag'] )): ?>
      <th style="width:16%">DIY</th>
      <?php endif; ?>
...
?>
        ...
        <td class="yen" style="text-align:left; padding-left:40px;"><?php echo nl2br($this->_var['goods']['goods_attr']); ?>
        
        
        
         <?php if (( $this->_var['goods']['car_goods_type'] == 3 )): ?>
           
           <p><?php echo $this->_var['goods']['type']; ?></p> 
           <p>右:<?php echo $this->_var['goods']['y_dushu']; ?>/<?php echo $this->_var['goods']['y_sanguang']; ?>*<?php echo $this->_var['goods']['y_zhouwei']; ?></p>
           <p>左:<?php echo $this->_var['goods']['z_dushu']; ?>/<?php echo $this->_var['goods']['z_sanguang']; ?>*<?php echo $this->_var['goods']['z_zhouwei']; ?></p>
           <p>瞳距:<?php echo $this->_var['goods']['y_tongju']; ?></p>
             <?php if (( $this->_var['goods']['y_xiajiaguang'] )): ?>
           
             <p>下加光:<?php echo $this->_var['goods']['y_xiajiaguang']; ?></p>
            <?php endif; ?>
        ...
        <?php endif; ?>
         ...
         <td style="width:16%;color:#333;">
         <?php if (( $this->_var['goods']['fittings_list'] )): ?>
         <?php if (( $this->_var['goods']['car_goods_type'] == 2 )): ?>
         <?php $_from = $this->_var['goods']['fittings_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'fittings');$this->_foreach['fittings'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['fittings']['total'] > 0):
    foreach ($_from AS $this->_var['fittings']):
        $this->_foreach['fittings']['iteration']++;
?>
         <div data="<?php echo $this->_var['fittings']['goods_id']; ?>"><?php echo $this->_var['fittings']['goods_name']; ?></div>
         <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
         <div data="<?php echo $this->_var['goods']['jk_colorid']; ?>">镜框颜色：<?php echo $this->_var['goods']['jk_color']; ?></div>
         <div data="<?php echo $this->_var['goods']['jt_colorid']; ?>">镜腿颜色：<?php echo $this->_var['goods']['jt_color']; ?></div>
         <?php endif; ?>
         <?php endif; ?>
         </td>
...
function orderAmountResponse(result)
{
  ...
  <div class="flowBox">
    ...
    <table width="100%" align="center" border="0" cellpadding="15" cellspacing="0" bgcolor="#fff" style="border:1px solid #ddd; margin:20px auto;" >
	  ...
	  <!-- 隐藏掉支付方式说明：支付宝网站(www.alipay.com) 是国内先进的网上支付平台。.....
      <tr>
