...
<div class="w mt10 clearfix">
  <div class="sub_main clearfix">
    ...
    <div class="art_relative">
	  ...
	  <?php $_from = get_cat_arts_12(0); if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'article_0_54757000_1477374723');$this->_foreach['artciles_list'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['artciles_list']['total'] > 0):
    foreach ($_from AS $this->_var['article_0_54757000_1477374723']):
        $this->_foreach['artciles_list']['iteration']++;
?>
        <li><i>&bull;</i><span><a href="<?php echo $this->_var['article_0_54757000_1477374723']['url']; ?>" target="_blank" title="<?php echo htmlspecialchars($this->_var['article_0_54757000_1477374723']['title']); ?>"><?php echo $this->_var['article_0_54757000_1477374723']['short_title']; ?></a></span></li>
      <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
      </ul>
    </div>
...
?>
  ...
  <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>	
    <div class="sideMod">
	  ...
	  <?php $_from = get_cat_arts_10(11); if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'article_0_54779600_1477374723');$this->_foreach['artciles_list'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['artciles_list']['total'] > 0):
    foreach ($_from AS $this->_var['article_0_54779600_1477374723']):
        $this->_foreach['artciles_list']['iteration']++;
?>
        <li class="clearfix"> <i class="<?php if ($this->_foreach['artciles_list']['iteration'] < 4): ?>i1<?php else: ?>i2<?php endif; ?>"> <?php echo $this->_foreach['artciles_list']['iteration']; ?></i> <span><a href="<?php echo $this->_var['article_0_54779600_1477374723']['url']; ?>" target="_blank" title="<?php echo htmlspecialchars($this->_var['article_0_54779600_1477374723']['title']); ?>"><?php echo $this->_var['article_0_54779600_1477374723']['short_title']; ?></a></span> </li>
	  <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>	
...
<div class="art_main w clearfix">
  <div class="art_nav clearfix Left">
	...
	<?php $_from = get_cat_arts_20(2); if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'article_0_54947800_1477374723');$this->_foreach['artciles_list'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['artciles_list']['total'] > 0):
    foreach ($_from AS $this->_var['article_0_54947800_1477374723']):
        $this->_foreach['artciles_list']['iteration']++;
?>
      <li class="art_box"> <a href="<?php echo $this->_var['article_0_54947800_1477374723']['url']; ?>" title="<?php echo htmlspecialchars($this->_var['article_0_54947800_1477374723']['title']); ?>" name="JS_art_title" class="art_box_title <?php if ($this->_var['article_0_54947800_1477374723']['id'] == $this->_var['id']): ?>current<?php endif; ?>" id="JS_art_1"><?php echo htmlspecialchars($this->_var['article_0_54947800_1477374723']['title']); ?><span>COMPANY</span></a> </li>
    <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?> 
