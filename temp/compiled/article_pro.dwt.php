...
<style type="text/css">
.art_main, .art_banner, .art_nav{padding:0;margin:0;border:none;}
/*---common----*/
.mt20{margin-top:20px;}
.mt30{margin-top:30px;}
.mb20{margin-bottom:20px;}
/*---banner---*/
div.art_banner{width:1188px;height:auto;padding:1px;border:solid 1px #d5d5d5;margin:10px auto 0;}
.art_banner img{display:block;}
/*---main---*/
div.art_main{height:auto;margin-top:10px;}
/*div nav*/
...
<div class="art_main w clearfix">
  <div class="art_nav clearfix Left">
	...
	<?php $_from = get_cat_arts_20(2); if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'article_0_65114600_1477397059');$this->_foreach['artciles_list'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['artciles_list']['total'] > 0):
    foreach ($_from AS $this->_var['article_0_65114600_1477397059']):
        $this->_foreach['artciles_list']['iteration']++;
?>
      <li class="art_box"> <a href="<?php echo $this->_var['article_0_65114600_1477397059']['url']; ?>" title="<?php echo htmlspecialchars($this->_var['article_0_65114600_1477397059']['title']); ?>" name="JS_art_title" class="art_box_title <?php if ($this->_var['article_0_65114600_1477397059']['id'] == $this->_var['id']): ?>current<?php endif; ?>" id="JS_art_1"><?php echo htmlspecialchars($this->_var['article_0_65114600_1477397059']['title']); ?><span>COMPANY</span></a> </li>
