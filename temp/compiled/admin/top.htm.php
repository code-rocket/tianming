...
<div id="Bomb-box">
			<div id="top">您有新消息！<img src="img/close21.png" style="width: 15px;height: 15px;padding:6px;float: right;cursor: pointer;"></div>
			<div id="center">
				您有<span id="span_one">2</span>个订单，已查看<span id="span_two">0</span>个<br />
				<a href="" style="float: right;margin-top: 25%;margin-right: 5%; ">查看详情</a>
			</div>
		</div>
...
<div id="header-div">
  ...
  <div id="submenu-div">
    <ul>
      <li><a href="index.php?act=about_us" target="main-frame">技术团队</a></li>
