    ...
    <div id="tabbar-div">
      <p>
        <span class="tab-front" id="general-tab"><?php echo $this->_var['lang']['tab_general']; ?></span>
          ...
          <?php endif; ?>
          <span class="tab-back" id="diygoods-tab">DIY配件</span>
           <span class="tab-back" id="goodscanshu-tab">眼镜参数</span>
          <span class="tab-back" id="article-tab"><?php echo $this->_var['lang']['tab_article']; ?></span>
      </p>
    </div>

    <!-- tab body -->
    <div id="tabbody-div" style="overflow:hidden;">
...
?>
          ...
          <tr>
            <td class="label"><?php echo $this->_var['lang']['lab_pic']; ?></td>
            <td>
              <input type="file" name="goods_pic" size="35" />
              <?php if ($this->_var['goods']['goods_pic']): ?>
                <a href="goods.php?act=show_image&img_url=images/upload/<?php echo $this->_var['goods']['goods_pic']; ?>" target="_blank"><img src="images/yes.gif" border="0" /></a>
              <?php else: ?>
                <img src="images/no.gif" />
              <?php endif; ?>
              <br /><input type="text" size="40" value="<?php echo $this->_var['lang']['lab_pic_url']; ?>" style="color:#aaa;" onfocus="if (this.value == '<?php echo $this->_var['lang']['lab_pic_url']; ?>'){this.value='http://';this.style.color='#000';}" name="goods_pic_url"/>
            </td>
          </tr>
...
?>
          ...
          <!-- 閰嶄欢 -->
          <table width="90%" id="diygoods-table" style="display:none" align="center">
              <!-- 鍟嗗搧鎼滅储 -->
              <tr>
                  <td colspan="3">
                      <img src="images/icon_search.gif" width="26" height="22" border="0" alt="SEARCH" />
                      <select name="cat_id4">
                          <option value="134">镜框</option>
                          <option value="131">镜腿</option>
                          <option value="45">镜片</option>
                      </select>
                      <select name="brand_id4"><option value="0"><?php echo $this->_var['lang']['all_brand']; ?><?php echo $this->html_options(array('options'=>$this->_var['brand_list'])); ?></select>
                      <input type="text" name="keyword4" />
                      <input type="button" value="<?php echo $this->_var['lang']['button_search']; ?>" onclick="searchGoods(sz4, 'cat_id4', 'brand_id4', 'keyword4')" class="button" />
                  </td>
              </tr>
              <!-- 鍟嗗搧鍒楄〃 -->
              <tr>
              ...
              <tr>
                  <td width="42%">
                      <select name="source_select4" size="20" style="width:100%" onchange="sz4.priceObj.value = this.options[this.selectedIndex].id" ondblclick="sz4.addItem(false, 'add_group_goods', goodsId, this.form.elements['price4'].value)">
                      </select>
                  </td>
                  <td align="center">
                      <p><?php echo $this->_var['lang']['price']; ?><br /><input name="price4" type="text" size="6" /></p>
                      <p><input type="button" value=">" onclick="sz4.addItem(false, 'add_diy_goods', goodsId, this.form.elements['price4'].value,$('select[name=\'cat_id4\']').val())" class="button" /></p>
                      <p><input type="button" value="<" onclick="sz4.dropItem(false, 'drop_diy_goods', goodsId, elements['is_single'][0].checked)" class="button" /></p>
                      <p><input type="button" value="<<" onclick="sz4.dropItem(true, 'drop_diy_goods', goodsId, elements['is_single'][0].checked)" class="button" /></p>
                  </td>
                  <td width="42%">
                      <select name="target_select4" size="20" style="width:100%" multiple ondblclick="sz4.dropItem(false, 'drop_diy_goods', goodsId, elements['is_single'][0].checked)">
                          <?php $_from = $this->_var['diy_goods_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'diy_goods1');if (count($_from)):
    foreach ($_from AS $this->_var['diy_goods1']):
?>
                          <option value="<?php echo $this->_var['diy_goods1']['diy_goods_id']; ?>"><?php echo $this->_var['diy_goods1']['goods_name']; ?></option>
                          <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                      </select>
                  </td>
              </tr>
        ...
        <table width="90%" id="goodscanshu-table" style="display:none;float:left;overflow:hidden;width:1500px;" align="center">
         ...
         <td id="tbody-goodsAttr" colspan="2" style="padding:0">
              ...
              <table width="100%" id="attrTable">
                  ...
                  <table style="width: 460px;float: left;margin:0 20px 20px 0;">
				          	<tr>
				          		<td class="label" style="padding-bottom: 20px;">
				          			<img src="img/jia.png" style="width: 30px;cursor: pointer;" onclick="add()"/>
				          		</td>
				          		<td class="label" style="float: right;margin-right: 10px;">
				          			<img id="img" src="img/del.png" style="width: 30px;cursor: pointer;" onclick="del(this)"/>
				          		</td>
				          	</tr>
                  
                  
                   <?php if ($this->_var['goods_diy_canshu_list']): ?>
             <?php $_from = $this->_var['goods_diy_canshu_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'diy_goods1');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['diy_goods1']):
?>
                  ...
                  <tr>
                  <td class="label">眼睛镜片的宽度（单位毫米）</td>
                  <td>
                 
                  <input name="jingpian_width[]" type="text" value="<?php echo $this->_var['diy_goods1']['jingpian_width']; ?>" size="40">  
                  
                  </td>
                  </tr>
                  <tr>
                  <td class="label">眼睛框架的总宽度（单位毫米）</td>
                  <td>
                
                  <input name="jingjia_width[]" type="text" value="<?php echo $this->_var['diy_goods1']['jingjia_width']; ?>" size="40">  
                 
                  </td>
                  </tr>
                  <tr>
                  <td class="label">眼睛鼻托处的宽度（单位毫米）</td>
                  <td>
                 
                  <input name="bituo_width[]" type="text" value="<?php echo $this->_var['diy_goods1']['bituo_width']; ?>" size="40">  
                 
                  </td>
                  </tr>
                  <tr>
                  <td class="label">眼睛镜片的高度（单位毫米）</td>
                  <td>
                  
                  <input name="jingpian_height[]" type="text" value="<?php echo $this->_var['diy_goods1']['jingpian_height']; ?>" size="40">  
                  ...
                  <input name="jingpian_width[]" type="text" value="<?php echo $this->_var['diy_goods1'][$this->_var['key']['jingpian_width']]; ?>" size="40">  
                  ...
                  <input name="jingjia_width[]" type="text" value="<?php echo $this->_var['diy_goods1'][$this->_var['key']['jingjia_width']]; ?>" size="40">  
                  ...
                  <input name="bituo_width[]" type="text" value="<?php echo $this->_var['diy_goods1'][$this->_var['key']['bituo_width']]; ?>" size="40">  
                  ...
                  <input name="jingpian_height[]" type="text" value="<?php echo $this->_var['diy_goods1'][$this->_var['key']['jingpian_height']]; ?>" size="40">  
         ...
         <script type="text/javascript">
			function add(){
				$("<table style='padding:0;width: 470px;height:160px;margin:0 20px 20px 0;padding-top:60px;float: left;'></table>")
							.append("<tr><td class='label'>眼睛镜片的宽度（单位毫米）</td><td><input name='jingpian_width[]' type='text' value='' size='40'></td></tr>")
							.append("<tr><td class='label'>眼睛框架的总宽度（单位毫米）</td><td> <input name='jingjia_width[]' type='text' value='' size='40'></td></tr>")
							.append("<tr><td class='label'>眼睛鼻托处的宽度（单位毫米）</td><td><input name='bituo_width[]' type='text' value='' size='40'></td></tr>")
							.append("<tr><td class='label'>眼睛镜片的高度（单位毫米）</td><td><input name='jingpian_height[]' type='text' value='' size='40'></td></tr>")
							.appendTo("#attrTable>tbody>tr>td")
							;
			}
			function del(){
				var a=$("#attrTable>tbody>tr>td table").length;
				if(a>=2){
					$("#attrTable>tbody>tr>td table:last-child").remove();
				}
...
<script language="JavaScript">
  ...
  var sz4 = new SelectZone(2, elements['source_select4'], elements['target_select4'], elements['price4']);
