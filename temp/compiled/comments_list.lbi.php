    ...
    <div id="JS_reply_page" class="Right clearfix">
      <form name="selectPageForm" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="get">
        ...
        <div id="pager"> <?php echo $this->_var['lang']['pager_1']; ?><?php echo $this->_var['pager']['record_count']; ?><?php echo $this->_var['lang']['pager_2']; ?><?php echo $this->_var['lang']['pager_3']; ?><?php echo $this->_var['pager']['page_count']; ?><?php echo $this->_var['lang']['pager_4']; ?> <span> <a href="<?php echo $this->_var['pager']['page_first']; ?>"><?php echo $this->_var['lang']['page_first']; ?></a> <a href="<?php echo $this->_var['pager']['page_prev']; ?>"><?php echo $this->_var['lang']['page_prev']; ?></a> <a href="<?php echo $this->_var['pager']['page_next']; ?>"><?php echo $this->_var['lang']['page_next']; ?></a> <a href="<?php echo $this->_var['pager']['page_last']; ?>"><?php echo $this->_var['lang']['page_last']; ?></a> </span>
          <?php $_from = $this->_var['pager']['search']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'item_0_23474100_1477450466');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['item_0_23474100_1477450466']):
?>
          <input type="hidden" name="<?php echo $this->_var['key']; ?>" value="<?php echo $this->_var['item_0_23474100_1477450466']; ?>" />
          <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
        </div>
        <?php else: ?>
        ...
        <div id="pager" class="pagebar"> <span class="f_l f6" style="margin-right:10px;"><?php echo $this->_var['lang']['total']; ?> <b><?php echo $this->_var['pager']['record_count']; ?></b> <?php echo $this->_var['lang']['user_comment_num']; ?></span>
          ...
          <?php endif; ?>
          <?php $_from = $this->_var['pager']['page_number']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'item_0_23501100_1477450466');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['item_0_23501100_1477450466']):
?>
          <?php if ($this->_var['pager']['page'] == $this->_var['key']): ?>
          <span class="page_now"><?php echo $this->_var['key']; ?></span>
          <?php else: ?>
          <a href="<?php echo $this->_var['item_0_23501100_1477450466']; ?>">[<?php echo $this->_var['key']; ?>]</a>
          <?php endif; ?>
          <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
          ...
          <?php $_from = $this->_var['pager']['search']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'item_0_23535900_1477450466');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['item_0_23535900_1477450466']):
?>
          <input type="hidden" name="<?php echo $this->_var['key']; ?>" value="<?php echo $this->_var['item_0_23535900_1477450466']; ?>" />
          <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
    ...
    <form action="javascript:;" onsubmit="submitComment(this)" method="post" name="commentForm" id="commentForm">
      <div class="reply_thread_box JS_reply_box" style="">
        <table width="300px" border="0" cellspacing="5" cellpadding="8" class="table_comment">
          <tr>
            <td><textarea class="reply_textarea JS_edit_reply" maxlength="140" id="reply_thread_textarea" rows="1" style="height: 32px; width:688px; font-size:12px" name="content"></textarea></td>
          </tr>
          <tr>
            <td><div style="text-align:left; float:left;">
                <input type="text" name="captcha"  class="inputBorder" style="width:66px;"/>
...
//<![CDATA[
<?php $_from = $this->_var['lang']['cmt_lang']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'item_0_23552100_1477450466');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['item_0_23552100_1477450466']):
?>
var <?php echo $this->_var['key']; ?> = "<?php echo $this->_var['item_0_23552100_1477450466']; ?>";
<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
	...
	<form name="selectPageForm" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="get">
        ...
        <div id="pager">
          <?php echo $this->_var['lang']['pager_1']; ?><?php echo $this->_var['pager']['record_count']; ?><?php echo $this->_var['lang']['pager_2']; ?><?php echo $this->_var['lang']['pager_3']; ?><?php echo $this->_var['pager']['page_count']; ?><?php echo $this->_var['lang']['pager_4']; ?> <span> <a href="<?php echo $this->_var['pager']['page_first']; ?>"><?php echo $this->_var['lang']['page_first']; ?></a> <a href="<?php echo $this->_var['pager']['page_prev']; ?>"><?php echo $this->_var['lang']['page_prev']; ?></a> <a href="<?php echo $this->_var['pager']['page_next']; ?>"><?php echo $this->_var['lang']['page_next']; ?></a> <a href="<?php echo $this->_var['pager']['page_last']; ?>"><?php echo $this->_var['lang']['page_last']; ?></a> </span>
            <?php $_from = $this->_var['pager']['search']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'item_0_23633100_1477450466');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['item_0_23633100_1477450466']):
?>
            <input type="hidden" name="<?php echo $this->_var['key']; ?>" value="<?php echo $this->_var['item_0_23633100_1477450466']; ?>" />
            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
        </div>
        <?php else: ?>
         ...
         <div id="pager" class="pagebar">
          ...
          <?php $_from = $this->_var['pager']['page_number']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'item_0_23659500_1477450466');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['item_0_23659500_1477450466']):
?>
                <?php if ($this->_var['pager']['page'] == $this->_var['key']): ?>
                <span class="page_now"><?php echo $this->_var['key']; ?></span>
                <?php else: ?>
                <a href="<?php echo $this->_var['item_0_23659500_1477450466']; ?>">[<?php echo $this->_var['key']; ?>]</a>
                <?php endif; ?>
            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
          ...
          <?php if ($this->_var['pager']['page_kbd']): ?>
            <?php $_from = $this->_var['pager']['search']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'item_0_23691700_1477450466');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['item_0_23691700_1477450466']):
?>
            <input type="hidden" name="<?php echo $this->_var['key']; ?>" value="<?php echo $this->_var['item_0_23691700_1477450466']; ?>" />
            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
...
<script type="text/javascript">
//<![CDATA[
<?php $_from = $this->_var['lang']['cmt_lang']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'item_0_23723800_1477450466');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['item_0_23723800_1477450466']):
?>
var <?php echo $this->_var['key']; ?> = "<?php echo $this->_var['item_0_23723800_1477450466']; ?>";
<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
