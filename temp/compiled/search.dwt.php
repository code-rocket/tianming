...
?><?php if ($this->_foreach['get_goods_ex']['iteration'] == 1): ?><?php if ($this->_var['goods_data']['goods_flag'] != ''): ?><div class="float_bg"><span class="text3"><?php if ($this->_var['goods_data']['goods_flag'] == 'promote'): ?>抢购<?php endif; ?><?php if ($this->_var['goods_data']['goods_flag'] == 'new'): ?>新品<?php endif; ?><?php if ($this->_var['goods_data']['goods_flag'] == 'best'): ?>特价<?php endif; ?><?php if ($this->_var['goods_data']['goods_flag'] == 'hot'): ?>热销<?php endif; ?></span></div><?php endif; ?><?php endif; ?><?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
        ...
        <div class="info">
          ...
          <span>
          	<ul>
            	<li style="margin-right:8px; float:left; width:19px; height:19px; background:#F00; cursor:pointer;"></li>
                <li style="margin-right:8px; float:left; width:19px; height:19px; background:#00F; cursor:pointer;"></li>
                <li style="margin-right:8px; float:left; width:19px; height:19px; background:#09F; cursor:pointer;"></li>
               
            </ul>
          </span>
          <span class="red bold yen f16">
              <span class="JS_show_price_ajax" data-goods_id=""><?php if ($this->_var['goods']['promote_price'] != ""): ?><?php echo $this->_var['goods']['promote_price']; ?><?php else: ?><?php echo $this->_var['goods']['shop_price']; ?><?php endif; ?></span>
          </span>&nbsp;
          <span class="yen gray"><del><?php echo $this->_var['goods']['market_price']; ?></del>&nbsp;|&nbsp;</span>
          <span class="price red">销量：<span class="JS_sale_num_ajax"><?php $_from = get_goods_ex($GLOBALS[smarty]->_var[goods][goods_id]); if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'goods_data');$this->_foreach['get_goods_ex'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['get_goods_ex']['total'] > 0):
    foreach ($_from AS $this->_var['goods_data']):
        $this->_foreach['get_goods_ex']['iteration']++;
?><?php if ($this->_foreach['get_goods_ex']['iteration'] == 1): ?><?php echo $this->_var['goods_data']['total_sells']; ?><?php endif; ?><?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?></span></span>
          </p>
