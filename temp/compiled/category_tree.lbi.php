...
?><span><a <?php if ($this->_var['childer']['id'] == $this->_var['category']): ?>class="current"<?php endif; ?> href="<?php echo $this->_var['childer']['url']; ?>"><?php echo htmlspecialchars($this->_var['childer']['name']); ?></a></span><?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?> </dd>
        </dl>
